...
public class Simulation {
    ...
    Object resolve(Object value) {
        ...
        if (value instanceof Map map) {
            if (map.containsKey("op")) {
                ...
                double in1 = args.size() > 0 ? toDouble(resolve(args.get(0))) : 0;
    ...
    private boolean evaluateCondition(Object condition) {
        ...
        if (map.containsKey("eq")) return compareOp((List<Object>) map.get("eq"), 0);
        if (map.containsKey("neq")) return !compareOp((List<Object>) map.get("neq"), 0);
        if (map.containsKey("gt")) return compareOp((List<Object>) map.get("gt"), 1);
        if (map.containsKey("gte")) return compareOp((List<Object>) map.get("gte"), 2);
        if (map.containsKey("lt")) return compareOp((List<Object>) map.get("lt"), -1);
        if (map.containsKey("lte")) return compareOp((List<Object>) map.get("lte"), -2);
